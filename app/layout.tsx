...
export const metadata: Metadata = {
  ...
  description:
    "Helping artists, creatives, and professionals discover purpose, confidence, clarity and direction with Jennis Williamson.",
  generator: "v0.app",
  icons: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={cn("dark", dmSans.variable)}>
      <head>
        <Script
