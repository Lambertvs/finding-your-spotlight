    ...
    <div className="flex flex-1 flex-col gap-6 p-6 max-w-4xl">
      ...
      <div className="rounded-xl border bg-card text-card-foreground p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          ...
          <div className="p-3 rounded-lg border border-border/50 bg-muted/20 space-y-1">
            <span className="text-muted-foreground block text-[10px] uppercase font-mono">System Sender</span>
            <span className="font-medium text-emerald-400 font-mono">no-reply@findingyourspotlight.com</span>
          </div>

          <div className="p-3 rounded-lg border border-border/50 bg-muted/20 space-y-1">
            <span className="text-muted-foreground block text-[10px] uppercase font-mono">Client Reply-To Inbox</span>
            <span className="font-medium text-foreground font-mono">info@findingyourspotlight.com</span>
          </div>
        </div>

        <div className="p-3 rounded-lg border border-emerald-500/20 bg-emerald-500/5 text-xs text-muted-foreground">
          <span className="font-semibold text-emerald-400">Verified System Email Routing:</span> Outgoing booking receipts send from `no-reply@findingyourspotlight.com` with `reply_to: info@findingyourspotlight.com`. Any client replies route directly to Jennis's primary inbox.
        </div>
      ...
      {/* 2. Cloud Database & Storage Integration */}
      <div className="rounded-xl border bg-card text-card-foreground p-6 shadow-sm space-y-4 font-sans">
        <div className="flex items-center justify-between border-b pb-3">
          <div className="flex items-center gap-2">
            <DatabaseIcon className="w-5 h-5 text-amber-500" />
            <h2 className="text-lg font-semibold text-foreground">Cloud Database & Secure Object Storage</h2>
          </div>
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-3 rounded-lg border border-border/50 bg-muted/20 space-y-1">
            <span className="text-muted-foreground block text-[10px] uppercase font-mono">Database Status</span>
            <span className="font-medium text-emerald-400 font-mono">Online & Encrypted</span>
          </div>
